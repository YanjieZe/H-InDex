...
import rrl.representations.dino.vision_transformer_flexible as vits
...
class DINO(nn.Module):
    ...
    def forward(self, img, return_cls_attention=False, return_cls_token=False):
        ...
        if return_cls_token:
            return features, output_cls_tokens
        return features
