...
class WaterPouringEnv(MujocoEnv):
    ...
    def compute_success(self):
        # water_percent = np.sum(self.check_success_particles()) / self.num_particles
        success = self.get_current_water_percentage() > 0.3
        return success, self.get_current_water_percentage(), success
