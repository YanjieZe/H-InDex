...
class PPO:
        ...
        if self.is_testing:
            ...
            for it in range(self.current_learning_iteration, num_learning_iterations):
                ...
                for _ in range(self.num_transitions_per_env):
                    ...
                    self.current_frame_count += self.vec_env.num_envs
    ...
    def log(
        ...
        if self.use_wandb:
            wandb.log({
                "train/mean_traj_reward":rewbuffer_mean,
                "train/mean_success_rate":mean_success_rate,
                "train/mean_step_reward":mean_reward,}, step=self.tot_timesteps)
