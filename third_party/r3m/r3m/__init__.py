...
def load_r3m(modelid, model_and_config_folder):
    ...
    modelpath = os.path.join(model_and_config_folder, "model.pt")
    configpath = os.path.join(model_and_config_folder, "config.yaml")
